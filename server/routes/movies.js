...
const movies = [
  ...
  },
  {
    ...
    description:
      "A Russian task force, led by Andrei Shatalov, is dispatched to recapture the Slatina Air Base in Kosovo and defend it from terrorists until reinforcements arrive.",
